...
// EnrollmentRepository enrollmentRepository = new EnrollmentRepository();
// EnrollmentValidator enrollmentValidator = new EnrollmentValidator();
// EnrollmentService enrollmentService = new
// EnrollmentService(enrollmentRepository, enrollmentValidator);

// // ======================== Student Management ========================
// System.out.println("========== STUDENT MANAGEMENT ==========");

// Student s1 = new Student("Yagnik", "Akbari", "yagnik@gmail.com",
// "bc-java-20");
// Student s2 = new Student("Kishan", "Akbari", "kishan.offical@gmail.com",
// "bc-java-20");
// Student s3 = new Student("Raj", "Akbari", "raj.akbari.97@gmail.com",
// "bc-java-21");
...
// // Add Courses
// Course c1 = new Course("Learn AI with Python", "You will be shocked by
// learning this course.", 3);
// Course c2 = new Course("Learn with Yagnik", "You will be shocked by him
// personality.", 7);
// Course c3 = new Course("Learn in universe", "You will be shocked by going to
// universe.", 69);
...
// System.out.println("\nMarked enrollment e1 (id=" + e1.getId() + ") as
// COMPLETED");
// } catch (EntityNotFoundException err) {
// System.out.println("EntityNotFoundException: " + err.getMessage());
// }
...
// System.out.println("Marked enrollment e2 (id=" + e2.getId() + ") as
// CANCELLED");
// } catch (EntityNotFoundException err) {
// System.out.println("EntityNotFoundException: " + err.getMessage());
// }
...
// System.out.println("Updated enrollment e3 (id=" + e3.getId() + ") status to
// COMPLETED");
// } catch (EntityNotFoundException err) {
// System.out.println("EntityNotFoundException: " + err.getMessage());
// }
